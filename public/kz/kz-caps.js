...
C('prepare','Prepare & send','Route a line to the counter that makes it — one station, no courses.','flame-outline','mid','starter'),
  ...
  { id:'inventory', name:'Inventory', icon:'cube-outline', tint:'#528cef',
    ...
    caps:[
      ...
      C('suppliers','Partner directory','Everyone you buy from or sell to — contacts, terms, lead time.','people-circle-outline','mid','starter','reference'),
      ...
      C('composite','Bundles & recipes','A sale depletes components.','layers-outline','full','standard'),
      C('services','Services','Sell time, not units — duration, staff, back-bar use.','time-outline','mid','starter'),
