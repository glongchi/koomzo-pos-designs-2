...
const MODULES = [
  ...
  { id: 'mobile',     group: 'floor', name: 'Mobile Register',      desc: 'The Flex register, phone composition.',        icon: 'phone-portrait-outline',  href: 'Koomzo POS - Retail Flex.html?device=phone',            chip: { label: '3 devices paired', tone: 'muted' } },
